function convertScript(source, plr)
	...
	source = source:gsub(":ChangeState", ".Parent.Parent.Parent.StatsService:Fire")
	source = source:gsub("%.Chatted", ".Parent.Parent:GetService'MaterialService'.LocalPlayer.Event")
